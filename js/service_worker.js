...
function FillForms(entry) {
  ...
  setTimeout(() => {
    ...
    const input_captcha = document.getElementById("A33");
    ...
    input_captcha.value = entry.captcha;
    ...
    // Auto-click the green button to confirm registration
    const green_button = document.getElementById("A55");
    green_button.click();
  ...
  // wait 1 sec
  setTimeout(() => {
    // Auto-click the ok green button to confirm registration
    const ok_button = document.getElementById("A138");
    ok_button.click();
    console.log("Green ok button clicked!");
  }, 1000);
}
